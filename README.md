...
The dataset includes 529 total events.  Additional datasets or a dateset augmented with synthetic data would be a prerequisite for a production-grade model which is highly generalizable to new ocean environments and different sensors, and able to detect rare call subtypes.  
