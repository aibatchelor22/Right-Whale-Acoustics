...
My primary interest here is to explore upshot calls of Right Whales and to build a TCN model and a TCN/CNN hybrid model, each capable of identifying such calls in an audio file.  
